  ...
  return (
    <div id="allocations-overview" className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        {/* 1. Tithe Card */}
        <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition-all space-y-2 shadow-sm">
          <div className="flex items-center justify-between">
        ...
        <div 
          ...
          className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-teal-500/40 transition-all space-y-2 cursor-pointer group shadow-sm"
        >
          <div className="flex items-center justify-between">
        ...
        <div 
          ...
          className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-blue-500/40 transition-all space-y-2 cursor-pointer group shadow-sm"
        >
          <div className="flex items-center justify-between">
        ...
        <div 
          onClick={() => onSelectTab?.('bills')}
          className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-rose-500/40 transition-all space-y-2 cursor-pointer group shadow-sm"
        >
          <div className="flex items-center justify-between">
